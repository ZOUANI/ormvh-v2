...
/**
 * REST controller for managing {@link com.ormvah.domain.Task}.
 */
@RestController
@RequestMapping("/api")
public class TaskResource {
    ...
    @GetMapping("/tasksByCourrier/{id}")
    public ResponseEntity<List<Task>> getAllTasksByCourrier(@PathVariable Long id) {
        TaskCriteria criteria = new TaskCriteria();
        criteria.setCourrierId((LongFilter) new LongFilter().setEquals(id));
        List<Task> page = taskQueryService.findByCriteria(criteria);
