...
import { CourrierComponent } from 'app/entities/courrier/courrier.component';
...
describe('Component Tests', () => {
  describe('Courrier Management Component', () => {
    let comp: CourrierComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CourrierComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.courriers && comp.courriers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
